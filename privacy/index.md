...
- **Photos from your sitter:** the sitter can optionally send a photo from the web link. The photo is compressed in their browser and stored in our **Cloudflare R2** bucket via a small server (a Cloudflare Worker). It is viewable only while the share is live — revoking or expiry blocks it immediately — and is **automatically deleted within 14 days**. Brindle copies it into your pet's photo gallery on your device. Photos are never used for any other purpose.
